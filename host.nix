...
let
  ...
  opEnergyFrontendPrototypeModule = import ./overlays/op-energy-prototype/module-frontend.nix { GIT_COMMIT_HASH = GIT_COMMIT_HASH OP_ENERGY_FRONTEND_PROTOTYPE_REPO_LOCATION; };
